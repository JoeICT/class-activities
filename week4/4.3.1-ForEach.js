...
const data = [
  ...
  data.forEach((place)=> console.log (place.address.city));
  ...
  classes.forEach((htmlElement, iteration) => htmlElement.textContent = `text content change, class week number ${iteration}`);